...
package net.heyspace.videoeditor.opengl.gles;
...
public class Drawable2d {
    ...
    private static final float CUSTOMIZE_COORDS[] = {
            -1f, -1.0f,    // 0 bottom left
            1.0f, -1.0f,   // 1 bottom right
            -1f, 1.0f,     // 2 top left
            1.0f, 1.0f,    // 3 top right
    };
    private static final float CUSTOMIZE_TEX_COORDS[] = {
            0.0f, 0.0f,      // 0 bottom left
            1.0f, 0.0f,      // 1 bottom right
            0.0f, 1.0f,      // 2 top left
            1.0f, 1.0f,      // 3 top right
    };
    private static final FloatBuffer CUSTOMIZE_BUF =
            GlUtil.createFloatBuffer(CUSTOMIZE_COORDS);
    private static FloatBuffer CUSTOMIZE_TEX_BUF =
            GlUtil.createFloatBuffer(CUSTOMIZE_TEX_COORDS);
     ...
     */
    public enum Prefab {
        TRIANGLE, RECTANGLE, FULL_RECTANGLE, CUSTOMIZE
    }
    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            ...
            case CUSTOMIZE:
                mVertexArray = CUSTOMIZE_BUF;
                mTexCoordArray = CUSTOMIZE_TEX_BUF;
                mCoordsPerVertex = 2;
                mVertexStride = mCoordsPerVertex * SIZEOF_FLOAT;
                mVertexCount = CUSTOMIZE_COORDS.length / mCoordsPerVertex;
                break;
